  ...
  return (
    <View className="flex-1 bg-[#faf8ff] px-6 pt-12 pb-8">
      ...
      <View className="gap-3">
        {!isLastExercise ? (
          <TouchableOpacity
            className="bg-[#0c56d0] rounded-full flex-row items-center justify-center min-h-[60px] active:bg-[#0a46a8]"
            onPress={onNext}
          >
          ...
          <TouchableOpacity
            className="bg-[#4CAF50] rounded-full flex-row items-center justify-center min-h-[60px] active:opacity-90"
            onPress={onNext}
          >
        ...
        <TouchableOpacity
          className="bg-transparent border-2 border-[#c3c6d6] rounded-full flex-row items-center justify-center min-h-[56px] active:bg-[#ededf8]"
